 ...
 * with ppfx weights.
 * Addition: re-calculate the flux at the window to be at the detector and fill a new histogram
 * this should be more equivalent to the way nova and marco calculated the flux
 *
