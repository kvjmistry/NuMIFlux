...
h_pionplus_MIPP_nue_dm11 = f.Get("pionplus_MIPP_nue")

c4 = TCanvas("c1","c1",1500,1200)

h_pionplus_MIPP_nue_dm11.SetTitle("#nu_{e}s from #pi^{+} ancestor parent" )
h_pionplus_MIPP_nue_dm11.GetXaxis().SetTitle("p_{Z} [GeV/c]")
h_pionplus_MIPP_nue_dm11.GetXaxis().SetTitleFont(12)
h_pionplus_MIPP_nue_dm11.GetYaxis().SetTitle("p_{T} [GeV/c]")
h_pionplus_MIPP_nue_dm11.GetYaxis().SetTitleFont(12)
h_pionplus_MIPP_nue_dm11.GetXaxis().SetRangeUser(0,110)
h_pionplus_MIPP_nue_dm11.GetYaxis().SetRangeUser(0, 5)
h_pionplus_MIPP_nue_dm11.Draw("colz")
