...
h_pionminus_long_trans = f.Get("pionminus_MIPP_nue")

c4 = TCanvas("c1","c1",1500,1200)

h_pionminus_long_trans.SetTitle("#nu_{e}s from #pi^{-} ancestor parent")
h_pionminus_long_trans.GetXaxis().SetTitle("p_{T} [GeV/c]")
h_pionminus_long_trans.GetXaxis().SetTitleFont(12)
h_pionminus_long_trans.GetYaxis().SetTitle("p_{L} [GeV/c]")
h_pionminus_long_trans.GetYaxis().SetTitleFont(12)
h_pionminus_long_trans.GetXaxis().SetRangeUser(0,110)
