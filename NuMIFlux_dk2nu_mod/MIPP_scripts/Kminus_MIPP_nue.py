# script to plot the electron neutrinos from tgp particle Kminus
...
h_Kminus_long_trans = f.Get("Kminus_MIPP_nue")

c4 = TCanvas("c1","c1",1500,1200)

h_Kminus_long_trans.SetTitle("#nu_{e}s from K^{-} ancestor parent")
...
h_Kminus_long_trans.GetYaxis().SetRangeUser(0, 5)
