...
void plot_gsimple_flux(const char* horn, const char* mode) {
	...
	if (!strcmp(horn,"fhc")) {
		boolfile  = GetFile(f_ppfx_mod ,"/uboone/data/users/kmistry/work/PPFX/uboone/beamline_zero_threshold_v46/FHC/output_uboone_fhc_run0_set1.root");
		...
		boolfile  = GetFile(f_ppfx_mod ,"/uboone/data/users/kmistry/work/PPFX/uboone/beamline_zero_threshold_v46/RHC/output_uboone_rhc_run0_set1.root");
		if (boolfile == false) gSystem->Exit(0);
