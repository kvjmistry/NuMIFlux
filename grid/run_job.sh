...
####################################
 ...
 ifdh cp /pnfs/sbnd/scratch/users/chill2/libraryanalyze_light_histo .
 ifdh cp /pnfs/sbnd/scratch/users/chill2/posPMTs_setup1.txt .
 ifdh cp /pnfs/sbnd/scratch/users/chill2/Lib154PMTs8inch_FullFoilsTPB.root .

####### 
####### ifdh cp does not preserve permissions, so need to add executable. #########
#######
 chmod u+x libraryanalyze_light_histo
